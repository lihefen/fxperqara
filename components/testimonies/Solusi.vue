  ...
  <div>
    ...
    <div class="xl:flex xl:justify-center">
      <div id="wrapper-carousel" class="max-w-[1280px] xl:px-40">
        ...
        >
          <UCarousel ref="carousel" v-slot="{ item }" :items="items" :ui="{ item: 'basis-auto' }" class="inline-flex gap-4 md:gap-6 w-full" @select="onSelect">
            <div
              class="w-52 pt-4 h-auto md:w-60 lg:w-[290px] xl:w-[320px] bg-white rounded-md shadow"
            >
              ...
              <div class="flex justify-between">
                <div class="flex items-center pl-4 py-2">
                  <svg
                    ...
                    stroke-width="1.5"
                    stroke="none"
                    class="w-4 h-4 md:w-6 md:h-6 fill-blue-2 stroke-blue-2"
                  >
                    <path
        ...
        <div class="hidden lg:flex flex-row justify-between mt-2">
          <div id="dots-slider" class="pt-2">
            <div class="inline-flex px-1">
              <button>
                <span
                  id="rounded-button"
                  class="w-3 h-3 rounded-full block bg-steelBlue"
                ></span>
              </button>
            </div>
          </div>
          <div class="flex">
            <button
              class="p-2 mx-1 my-2 shadow-md rounded-full bg-white"
              :disabled="prevBtnDisabled"
              :class="{ 'opacity-50!': prevBtnDisabled }"
            ...
            <button 
              class="p-2 my-2 shadow-md rounded-full bg-white" 
              :disabled="nextBtnDisabled" 
              :class="{ 'opacity-50!': nextBtnDisabled }"
...
const onSelect = () => {
  ...
  console.log(carousel.value.emblaApi.canScrollPrev())

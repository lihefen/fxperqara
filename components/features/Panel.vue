      ...
      >
        ...
        >
          ...
          ><a
            ...
            class="bg-white shadow-md p-3 space-y-2 md:space-y-4 rounded-xl md:flex-1 relative cursor-pointer"
            ><div
          ...
          ><a
            ...
            class="bg-white shadow-md p-3 space-y-2 md:space-y-4 rounded-xl md:max-w-[172px] cursor-pointer"
            ><div class="flex gap-2 items-center">
              <svg
                width="24"
                height="24"
